...
!(function() {
  var data = [
    {
      eventName: "yedang_event",
      calendar: "yedang",
      color: "red",
      eventTime: moment().recur().every(2).days()
    },

    {
      eventName: "lotte_event",
      calendar: "lotte",
      color: "orange",
      eventTime: moment()
    },
    {
      eventName: "kumho_event",
      calendar: "kumho",
      color: "yellow",
      eventTime: moment()
    },
    {
      eventName: "sejong_event",
      calendar: "sejong",
      color: "green",
      eventTime: moment().add("days"  , 2)
    },

    {
      eventName: "thehouse_event",
      calendar: "thehouse",
      color: "blue",
      eventTime: moment()
    },
